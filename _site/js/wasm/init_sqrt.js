...
var wasmBinaryFile = 'init_sqrt.wasm';
...
var ASM_CONSTS = {
  1084: function($0) {console.log('I recieved: ' + $0);}
};
function js_alert(){ alert('hello emscripten'); }
...
var asmLibraryArg = { "emscripten_asm_const_int": _emscripten_asm_const_int, "emscripten_run_script": _emscripten_run_script, "js_alert": js_alert, "memory": wasmMemory };
var asm = createWasm();
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var ___em_js__js_alert = Module["___em_js__js_alert"] = createExportWrapper("__em_js__js_alert");
